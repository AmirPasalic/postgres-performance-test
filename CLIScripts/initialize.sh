...
function help {
    echo ""
    echo "NAME"
    echo "$TAB ppt_initialize"
    echo ""
    echo "DESCRIPTION"
    echo "$TAB ppt_initialize help page"
    ...
    echo "$TAB Example ppt_performance-test --help or ppt_performance-test -h"
    echo ""
    echo "$TAB This database can be removed with all its data with the ppt_cleanup command."
    echo "$TAB More infos on that you can find by visiting the help page of the ppt_cleanup command."
